#The Sparks Foundation JAN21 IOT & Computer Vision Internship
#Author- Anurag Pandey https://github.com/eagleanurag
#calculating the rgb values of the pixel which we double click
